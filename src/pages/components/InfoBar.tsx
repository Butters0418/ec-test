...
function InfoBar() {
  ...
  return (
    <div className={`bg-black text-white overflow-hidden transition-all duration-500 ${isOpen ? "opacity-100 max-h-9.5" : "opacity-0 max-h-0"}`}>
      <div className="max-w-310 mx-auto flex justify-center md:justify-between items-center py-2 px-1 xl:px-0">
        <div className="w-5 hidden md:block" aria-hidden="true"></div>
        ...
        <button type="button" onClick={handleClick} className="w-5 h-5 hidden md:flex items-center justify-center hover-fade">
